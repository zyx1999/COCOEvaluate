...
class MSCOCO(DETECTION):
    ...
    def _extract_data(self):
        # self._coco    = COCO(self._label_file)
        _coco_dir = os.path.join(system_configs.data_dir, "coco")
        _label_dir  = os.path.join(_coco_dir, "annotations")
        _label_file = os.path.join(_label_dir, "instances_{}.json")
        _label_file = _label_file.format("trainval2014")
        self._coco    = COCO(_label_file)
